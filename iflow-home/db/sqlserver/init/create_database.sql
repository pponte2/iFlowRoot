...
DROP TABLE IF EXISTS `iflow`.`user_calendar`;
...
DROP TABLE IF EXISTS `iflow`.`profiles_calendar`;
...
DROP TABLE IF EXISTS `iflow`.`flow_calendar`;
...
DROP TABLE IF EXISTS `iflow`.`calendar_holidays`;
...
DROP TABLE IF EXISTS `iflow`.`calendar_periods`;
